...
function HomePage() {
  ...
  return (
    <>
      <style>{appleAnimationStyles}</style>
        ...
        <header className="sticky top-0 z-50 border-b border-black/5 bg-white/80 backdrop-blur-xl">
          <div className="flex items-center justify-between pl-0 pr-2 pt-3 pb-2 lg:mx-auto lg:max-w-6xl lg:gap-3 lg:px-8 lg:py-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="apple-button shrink-0 inline-flex h-12 items-center justify-center rounded-full bg-[#25D366] px-5 text-sm font-semibold text-white shadow-md hover:bg-[#1fb85a]"
            >
              Agendar consulta
            </a>
          </div>
          ...
          <section id="inicio" className="relative overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-5 py-4 lg:px-10 lg:py-6">
              <div className="mt-2 grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
                <div>
                  <div className="apple-fade-up inline-flex rounded-full border border-[#e8d8bc] bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-[#9d7a43] shadow-sm">
                  ...
                  <p className="apple-fade-up delay-2 mt-6 max-w-2xl text-base leading-7 text-slate-600 md:text-lg">
                    No ignores lo que estás sintiendo. Entre más pronto lo entiendas, más fácil es resolverlo.
                    Aquí recibes explicación clara, diagnóstico preciso y un plan real para recuperar tu tranquilidad.
                  </p>

                  <div className="apple-fade-up delay-3 mt-10 flex flex-col gap-3 sm:flex-row">
                    <a
                      href={whatsappUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="apple-button rounded-full bg-[#25D366] px-6 py-3 text-center text-sm font-semibold text-white shadow-md hover:bg-[#1fb85a]"
                    >
                    ...
                    <a
                      href={agendaUrl}
                      className="apple-button rounded-full border border-slate-300 bg-white px-6 py-3 text-center text-sm font-medium text-slate-700 hover:bg-slate-50"
                    >
                      Ver disponibilidad inmediata
                    </a>
                  </div>

                  <div className="apple-fade-up delay-4 mt-10 grid gap-4 sm:grid-cols-3">
                    <div className="apple-card rounded-[1.25rem] border border-black/5 bg-white p-4 shadow-sm">
                ...
                <div className="apple-fade-in delay-2 relative flex items-start justify-center pt-4">
              ...
              <div className="grid gap-0 lg:grid-cols-[1.05fr_0.95fr]">
                <div className="bg-gradient-to-br from-[#fff9f1] via-white to-[#fff5f4] p-8 md:p-12">
                  ...
                  <div className="mt-8 grid gap-5 md:grid-cols-3">
                    {routeSteps.map((step) => (
                      <div
                        key={step.n}
                        className="apple-card rounded-[1.75rem] border border-black/5 bg-white p-5 shadow-sm"
                      >
                ...
                <div className="bg-slate-950 p-8 text-white md:p-12">
                  ...
                  <div className="mt-8 space-y-5">
                    <div className="apple-card rounded-[1.75rem] bg-white/5 p-6 backdrop-blur">
            ...
            <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr]">
              ...
              <div className="grid gap-5 md:grid-cols-2">
                {differentiators.map((item) => (
                  <div
                    key={item}
                    className="apple-card rounded-[1.75rem] border border-black/5 bg-white p-7 shadow-sm"
                  >
            ...
            <div className="mx-auto max-w-7xl px-5 lg:px-10">
              ...
              <div className="mt-12 grid gap-8 lg:grid-cols-3">
                {services.map((service) => (
                  <div
                    key={service.title}
                    className="apple-card rounded-[1.75rem] border border-black/5 bg-white p-8 shadow-sm"
                  >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="apple-button mt-8 inline-flex rounded-full bg-[#25D366] px-6 py-3 text-sm font-semibold text-white hover:bg-[#1fb85a]"
                    >
              ...
              <div className="rounded-[2rem] border border-black/5 bg-slate-900 p-10 text-white shadow-xl md:p-14">
                ...
                <div className="mt-10 grid gap-5 md:grid-cols-3">
                  {surgerySteps.map((step) => (
                    <div key={step.n} className="apple-card rounded-[1.75rem] bg-white/10 p-6 backdrop-blur">
                ...
                <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="apple-button rounded-full bg-[#25D366] px-7 py-4 text-center text-sm font-semibold text-white hover:bg-[#1fb85a]"
                  >
                    Hablar directamente por WhatsApp
                  </a>
                  <a
                    href={agendaUrl}
                    className="apple-button rounded-full border border-white/20 px-7 py-4 text-center text-sm font-medium text-white hover:bg-white/5"
                  >
                    Ver disponibilidad inmediata
                  </a>
                </div>
              ...
              <div className="rounded-[2rem] border border-black/5 bg-white p-8 shadow-sm">
                ...
                <div className="mt-6 flex flex-wrap items-center gap-5">
                  ...
                  <img
                    ...
                    className="h-auto max-h-[4.5rem] object-contain"
                  />
                </div>
              </div>
              ...
              <div id="contacto" className="rounded-[1.75rem] bg-[#f7efe3] p-8 shadow-sm">
                ...
                <div className="mt-8 space-y-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="apple-button block rounded-full bg-[#25D366] px-7 py-4 text-center text-sm font-semibold text-white hover:bg-[#1fb85a]"
                  >
                    Hablar directamente por WhatsApp
                  </a>
                  ...
                  <a
                    href={agendaUrl}
                    className="apple-button block rounded-full border border-slate-300 bg-white px-7 py-4 text-center text-sm font-medium text-slate-700 hover:bg-slate-50"
                  >
                    Ver disponibilidad inmediata
                  </a>
                </div>

                <div className="mt-8 rounded-[1.25rem] border border-black/5 bg-white p-5 text-sm leading-7 text-slate-700">
